...
<form action="<?php echo htmlspecialchars($dir_page);?>" method="post" name="signin02" target="_self" id="signin02">
  ...
  <p>
  <label class="sr-only" for="txtemail">Contraseña</label>
    <input type="password" name="txtpasword" id="txtpasword" required placeholder="Contraseña" />
  </p>
  <p>
  <button onClick="abrirSesion()" class="btn btn-primary primary-btn primary-button" type="submit" name="btningresar" id="btningresar"> Iniciar Sesión </button>
